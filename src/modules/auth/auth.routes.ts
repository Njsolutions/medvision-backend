...
export function authRoutes(app: FastifyInstance) {
	...
	app.post('/register', { preHandler: [app.authenticate] }, async (req, res) => controller.register(req, res))
	...
	app.post('/patient-signin', async (req, res) => controller.patientSimpleSignIn(req, res))
